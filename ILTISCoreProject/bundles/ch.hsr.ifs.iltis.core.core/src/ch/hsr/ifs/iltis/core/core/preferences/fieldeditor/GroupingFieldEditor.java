...
public abstract class GroupingFieldEditor extends FieldEditor {
    ...
    public GroupingFieldEditor(final String name, final String captionText, final Composite parent, final int numColumnsInternal,
    ...
    /**
     * Returns the internal composite. The composite can then be passed as parent
     * to the containing field editors
     *
