...
public interface Function3<P1, P2, P3, R> {
    ...
    default Function2<P2, P3, R> curry(final P1 param1) {
        return new CurriedFunction2<>(param1, this);
    }
...
class CurriedFunction2<P1, P2, P3, R> implements Function2<P2, P3, R> {
    ...
    private final Function3<P1, P2, P3, R> fun;

    protected CurriedFunction2(final P1 param1, final Function3<P1, P2, P3, R> fun) {
        this.param1 = param1;
        this.fun = fun;
    }

    @Override
    public R apply(final P2 param2, final P3 param3) {
