...
public class GroupFieldEditor extends GroupingFieldEditor {
     ...
     * In how many columns the contained FieldEditors shall be aligned
     * @param numColumnsExternal
     * In how many columns the GroupFieldEditor shall appear for external
     * observers
     */
    public GroupFieldEditor(final String name, final String captionText, final Composite parent, final int numColumnsInternal,
                            final int numColumnsExternal) {
     ...
     * be passed as an argument, else it will adjust to the minimum width required
     * by the components
     *
     * @param name
     * The name of the preference this field editor works on
     ...
     */
    public GroupFieldEditor(final String name, final String captionText, final Composite parent, final int numColumnsInternal,
                            final int numColumnsExternal, final int marginInPx) {
