...
public abstract class AbstractPair<T1, T2> {
     ...
     */
    public <SndPair> boolean equals(final SndPair obj, final Equals<AbstractPair<?, ?>, SndPair> comparator) {
    ...
    public static abstract class AbstractPairEquals<Other> implements Equals<AbstractPair<?, ?>, Other> {
         ...
         */
        @SuppressWarnings("rawtypes")
        public Object accessFirst(final Other obj) {
         ...
         */
        @SuppressWarnings("rawtypes")
        public Object accessSecond(final Other obj) {
            if (obj instanceof AbstractPair) {
    ...
    public static <T1, T2> boolean allElementEquals(final AbstractPair<T1, T2> pair) {
     ...
     */
    public static <T1, T2> boolean notAllElementEquals(final AbstractPair<T1, T2> pair) {
    ...
    public static <T1, T2> boolean allElementEquals(final Equals<T1, T2> comparator, final AbstractPair<T1, T2> pair) {

        final Optional<T1> fst = pair.first instanceof AbstractPair ? ((AbstractPair) pair.first).getValueIfAllValuesSame(comparator) : Optional
                .ofNullable(pair.first);
        final Optional<T2> snd = pair.second instanceof AbstractPair ? ((AbstractPair) pair.second).getValueIfAllValuesSame(comparator) : Optional
                .ofNullable(pair.second);
    ...
    protected static class NestingHelper<ST1, ST2> extends AbstractPair<ST1, ST2> {
        ...
        public NestingHelper(final ST1 first, final ST2 second) {
            super(first, second);
        }
