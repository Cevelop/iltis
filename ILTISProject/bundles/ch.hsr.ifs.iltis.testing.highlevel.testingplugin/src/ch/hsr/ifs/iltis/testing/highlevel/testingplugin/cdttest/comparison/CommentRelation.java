...
public class CommentRelation {
    ...
    public static ComparisonResult equals(CommentRelation left, CommentRelation right, EnumSet<ComparisonArg> args) {
        if (right == null || left == null) {
            return new ComparisonResult(ComparisonState.NO_COUNTERPART, ASTComparison.generateBasicComparisonResultAttributes(left == null ? null
                                                                                                                                           : left.comment,
                    right == null ? null : right.comment, args));
        }
