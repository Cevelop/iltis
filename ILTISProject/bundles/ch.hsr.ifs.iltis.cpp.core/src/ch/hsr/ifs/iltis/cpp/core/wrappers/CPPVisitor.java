...
public class CPPVisitor {
    ...
    public IASTDeclaration[] extractActiveDeclarations(final IASTDeclaration[] arg0, final int arg1) {
    ...
    public static class CollectDeclarationsAction extends
            org.eclipse.cdt.internal.core.dom.parser.cpp.semantics.CPPVisitor.CollectDeclarationsAction {

        public CollectDeclarationsAction(final IBinding binding, final boolean permissive) {
    ...
    public IType createType(final ICPPASTInitCapture arg0) {
    ...
    public IASTName[] getDeclarations(final IASTTranslationUnit arg0, final IBinding arg1, final boolean arg2) {
    ...
    public static IASTDeclarator findInnermostDeclarator(final IASTDeclarator arg0) {
        return ASTQueries.findInnermostDeclarator(arg0);
    }

    public static IASTDeclarator findOutermostDeclarator(final IASTDeclarator arg0) {
        return ASTQueries.findOutermostDeclarator(arg0);
    }
    ...
    public static <T extends IASTNode> Optional<T> findAncestorWithType(final IASTNode node, final Class<T> T) {
        return Optional.ofNullable(ASTQueries.findAncestorWithType(node, T));
    }

    public static <T extends IASTNode> Optional<T> findChildWithType(final IASTNode node, final Class<T> T) {
        ...
        for (final IASTNode child : node.getChildren()) {
            final Optional<T> currentNode = findChildWithType(child, T);
