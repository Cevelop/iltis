package ch.hsr.ifs.iltis.core.ui.jface;
...
public class TextSelectionUtil {
     ...
     */
    public static boolean contains(final ITextSelection outer, final ITextSelection inner) {
     ...
     */
    public static boolean contains(final ITextSelection sel, final int offset) {
     ...
     */
    public static int getEndOffset(final ITextSelection sel) {
