...
public class LinkFieldEditor extends FieldEditor {
    ...
    /**
     * All links can use the same preference name since they don't store any
     * preference.
     *
     * @param linkText
     * text for the link
     * @param listener
     * SelectionListener to activate on widgetSelected() and on
    ...
    /**
     * Adjusts the field editor to be displayed correctly for the given number of
     * columns.
     *
     * @param numColumns
     * number of columns
