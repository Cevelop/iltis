...
public class StringList extends AbstractMutableList<String> implements IStringifyable<StringList> {
   ...
   public StringList(int initialCapacity) {
      this.items = initialCapacity == 0 ? ZERO_SIZED_ARRAY : new String[initialCapacity];
   }

   protected StringList(String[] array) {
      this(array.length, array);
   }

   protected StringList(int size, String[] array) {
      this.size = size;
      this.items = array;
   }

   public StringList(Collection<String> source) {
      this.items = (String[]) source.toArray();
   ...
   public static StringList wrapCopy(String... array) {
      String[] newArray = new String[array.length];
      System.arraycopy(array, 0, newArray, 0, array.length);
      return new StringList(newArray);
   }

   public static StringList newList(int initialCapacity) {
    ...
    */
   public static StringList newListWith(String... elements) {
   ...
   @Override
   public StringList unstringify(String string) {
   ...
   @Override
   public boolean addAll(int index, Collection<? extends String> source) {
   ...
   private void addAtIndex(int index, String element) {
   ...
   private String[] copyItemsWithNewCapacity(int newCapacity) {
