...
public enum CPPBinaryOperator implements ICPPOperator {
    ...
    CPPBinaryOperator(final int relativePrecedence, final Associativity associativity, final int equivalentCDTOp) {
    ...
    public static CPPBinaryOperator getForCDTOperator(final int binaryOperator) {
        return ArrayIterate.detect(values(), v -> v.equivalentCDTOp == binaryOperator);
    }

    public static CPPBinaryOperator getForBinaryExpr(final IASTBinaryExpression expr) {
