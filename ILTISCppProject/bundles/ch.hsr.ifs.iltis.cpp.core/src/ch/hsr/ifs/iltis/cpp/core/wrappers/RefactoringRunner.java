...
public abstract class RefactoringRunner {
    ...
    public RefactoringRunner(final ICElement element, final Optional<ITextSelection> selection, final IShellProvider shellProvider,
    ...
    protected void createAndAddRefactoringContext(final CRefactoring refactoring) {
        new CRefactoringContext(refactoring);
    }

    public abstract void run();

    protected void run(final RefactoringWizard wizard, final CRefactoring refactoring, final int saveMode) {
