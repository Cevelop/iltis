...
public class EvaluateContributions {
   ...
   private static IVersionModificationOperation extractVersionModification(IConfigurationElement element) {
      try {
         if (!element.getName().equals(TAG_VERSION_MODIFICATION)) { return null; }
         if (element.getAttribute(TAG_OPERATION_CLASS) == null) { return null; }

         final Object o = element.createExecutableExtension(TAG_OPERATION_CLASS);
         if (o instanceof IVersionModificationOperation) { return (IVersionModificationOperation) o; }
