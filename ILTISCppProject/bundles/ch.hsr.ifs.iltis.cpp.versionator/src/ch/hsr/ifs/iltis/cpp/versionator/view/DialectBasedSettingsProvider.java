...
public final class DialectBasedSettingsProvider implements ITreeContentProvider, ILabelProvider, ICheckStateProvider {
   ...
   public boolean hasChildren(Object element) {
      if (element instanceof DialectBasedSetting) { return ((DialectBasedSetting) element).hasSubsettings(); }
      return false;
   }

   @Override
   public Object getParent(Object element) {
      if (element instanceof DialectBasedSetting) { return ((DialectBasedSetting) element).getParent(); }
      return null;
   }
   ...
   public String getText(Object element) {
      if (element instanceof DialectBasedSetting) { return ((DialectBasedSetting) element).getName(); }
      return "<unknown>";
   }
   ...
   public boolean isGrayed(Object element) {
      if (element instanceof DialectBasedSetting) {
         ...
         if (setting.getCheckedChildCount() < setting.getSubsettings().size()) { return true; }
      }
      return false;
   }
   ...
   public boolean isChecked(Object element) {
      if (element instanceof DialectBasedSetting) {
         DialectBasedSetting setting = ((DialectBasedSetting) element);
         if (childrenChecked(setting)) { return true; }
   ...
   private boolean childrenChecked(DialectBasedSetting setting) {
      if (setting.getCheckedChildCount() > 0) { return true; }
      for (DialectBasedSetting sub : setting.getSubsettings()) {
         if (childrenChecked(sub)) { return true; }
      }
      return false;
   }
}
