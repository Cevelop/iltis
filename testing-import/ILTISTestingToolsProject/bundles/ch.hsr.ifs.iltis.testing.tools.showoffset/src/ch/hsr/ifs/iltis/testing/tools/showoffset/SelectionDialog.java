package ch.hsr.ifs.iltis.testing.tools.showoffset;
...
public class SelectionDialog extends Dialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        fromText.addModifyListener(e -> from = Integer.parseInt(fromText.getText()));

        toText.addModifyListener(e -> to = Integer.parseInt(toText.getText()));
        return composite;
    }
