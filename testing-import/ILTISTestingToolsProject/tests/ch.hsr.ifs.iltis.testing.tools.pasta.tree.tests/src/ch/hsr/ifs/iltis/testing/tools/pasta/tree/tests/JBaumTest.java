...
public class JBaumTest {
    ...
    private TestNode<Point2D> createComplexTree() {
        TestNode<Point2D> root = new TestNode<>(new Point2D.Double(6.0, 0.0));
        TestNode<Point2D> leftChild = new TestNode<>(new Point2D.Double(2.0, 1.0));
        TestNode<Point2D> leftChildChild = new TestNode<>(new Point2D.Double(0.0, 2.0));
        TestNode<Point2D> leftChildChild2 = new TestNode<>(new Point2D.Double(2.0, 2.0));
        TestNode<Point2D> leftChildChild3 = new TestNode<>(new Point2D.Double(4.0, 2.0));
        TestNode<Point2D> centerChild = new TestNode<>(new Point2D.Double(6.0, 1.0));
        TestNode<Point2D> centerChildChild = new TestNode<>(new Point2D.Double(6.0, 2.0));
        TestNode<Point2D> centerRightChild = new TestNode<>(new Point2D.Double(8.0, 1.0));
        TestNode<Point2D> rightChild = new TestNode<>(new Point2D.Double(10.0, 1.0));
