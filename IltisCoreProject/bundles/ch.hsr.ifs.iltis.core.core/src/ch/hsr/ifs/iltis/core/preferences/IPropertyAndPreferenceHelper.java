...
public interface IPropertyAndPreferenceHelper {
   ...
   /**
    * Preference that will be set if the selected project should use project
   ...
   /**
    * Returns the qualifier (prefix) to all the preferences specified in this
    * page. If this identifier is the same for two unrelated
    * {@link IPropertyAndPreferenceHelper}, the {@link PreferencePage}s will
    * suffer from collisions.
    *
    * I.e. If there are three individual
    * {@link FieldEditorPropertyAndPreferencePage}s and either none or all of
    * them should have project specific preferences enabled, these three pages
   ...
   /**
    * If overridden this should return the default preference id qualifier. This
   ...
   /**
    * Returns the value stored for this name in this project if project is not
    * null and project specific preferences are enabled for this project, else
    * the value stored for this name in the workspace preferences
    *
   ...
   /**
    * Returns the default value for this name in this project if project is not
    * null and project specific preferences are enabled for this project, else
    * the default value for this name in the workspace preferences
    *
   ...
   /**
    * Returns the default value stored for this name in this project's
    * preferences
    *
    * @see IPreferenceStore#getDefaultBoolean(String)
    *
   ...
   /**
    * Sets the value for this name in this project if project is not null and
    * project specific preferences are enabled for this project, else the value
    * will be stored in the workspace preferences
    *
   ...
   /**
    * Sets the default value for this name in this project if project is not null
    * and project specific preferences are enabled for this project, else the
    * default value will be stored in the workspace preferences
    *
   ...
   /**
    * Enables / disables project specific preferences for the passed
    * {@code IProject}
    *
    * @param project
    *        The project for which to enable / disable specific preferences,
    *        not null
    * @param enabled
   ...
   /**
    * Tests if project specific preferences are enabled for the passed
    * {@code IProject}
    *
    * @param project
   ...
   /**
    * Returns if the PreferenceStore contains a preference with this name. Uses
    * the project specific preferences, if enabled. Else it uses the workspace
    * preferences
    *
    * @param name
    *        The preference name
