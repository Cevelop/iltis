...
public class CompositeFieldEditor extends GroupingFieldEditor {
   ...
   *          external observers
   */
  public CompositeFieldEditor(final String name, final Composite parent, final int numColumnsInternal,
   ...
   */
  public CompositeFieldEditor(final String name, final Composite parent, final int noOfColumnsInternal,
      final int noOfColumnsExternal, final int marginInPx) {
